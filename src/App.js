          ...
          <div className="top-right-strip row">
            ...
            <div className="top-hny-left-content col-lg-6 pl-lg-0">
              <h6>Upto 30% off on All styles , <a href="#" target="_blank"> Click here for <span
                    className="fa fa-hand-o-right hand-icon" aria-hidden="true"></span> <span
                    className="hignlaite">More details</span></a></h6>
            </div>
            {/* <!--//left--> */}
            {/* <!--/right--> */}
          ...
          <div className="container-fluid serarc-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="about.html">What We Offer</a>
                  </li>
      ...
      <div className="container py-lg-5">
        ...
        <div className="welcome-grids row mt-5">
          ...
          <div className="col-lg-2 col-md-4 col-6 welcome-image">
              <div className="boxhny13">
                  <a href="#URL">
                      <img src="assets/images/grid3.jpg" className="img-fluid" alt="" />
                  <div className="boxhny-content">
                    <h3 className="title">Product</h3>
                  </div>
                </a>
          ...
          <div className="col-lg-2 col-md-4 col-6 welcome-image">
              <div className="boxhny13">
                  <a href="#URL">
                      <img src="assets/images/grid2.jpg" className="img-fluid" alt="" />
                  <div className="boxhny-content">
                    <h3 className="title">Product</h3>
                  </div>
                </a>
          ...
          <div className="col-lg-2 col-md-4 col-6 welcome-image">
              <div className="boxhny13">
                  <a href="#URL">
                      <img src="assets/images/grid4.jpg" className="img-fluid" alt="" />
                  <div className="boxhny-content">
                    <h3 className="title">Product</h3>
                  </div>
                </a>
          ...
          <div className="col-lg-2 col-md-4 col-6 welcome-image">
              <div className="boxhny13">
                  <a href="#URL">
                      <img src="assets/images/grid5.jpg" className="img-fluid" alt="" />
                  <div className="boxhny-content">
                    <h3 className="title">Product</h3>
                  </div>
                </a>
          ...
          <div className="col-lg-2 col-md-4 col-6 welcome-image">
              <div className="boxhny13">
                  <a href="#URL">
                      <img src="assets/images/grid6.jpg" className="img-fluid" alt="" />
                  <div className="boxhny-content">
                    <h3 className="title">Product</h3>
                  </div>
                </a>
        ...
        <div className="ecom-products-grids row mt-lg-5 mt-3">
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2 transmitv">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-1.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-11.jpg"/>
                </a>
                <ul className="social">
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">Women Maroon Top </a></h3>
          ...
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-2.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-22.jpg"/>
                </a>
                <ul className="social">
                    <li><a href="#" data-tip="Quick View"><span className="fa fa-eye"></span></a></li>
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">Men's Pink Shirt </a></h3>
          ...
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-3.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-33.jpg"/>
                </a>
                <ul className="social">
                    <li><a href="#" data-tip="Quick View"><span className="fa fa-eye"></span></a></li>
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">Dark Blue Top </a></h3>
          ...
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-4.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-44.jpg"/>
                </a>
                <ul className="social">
                    <li><a href="#" data-tip="Quick View"><span className="fa fa-eye"></span></a></li>
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">Women Tunic </a></h3>
          ...
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-5.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-55.jpg"/>
                </a>
                <ul className="social">
                    <li><a href="#" data-tip="Quick View"><span className="fa fa-eye"></span></a></li>
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">Yellow T-Shirt</a></h3>
                <span className="price"><del>$575.00</del>$299.99</span>
              </div>
            </div>
          ...
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-6.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-66.jpg"/>
                </a>
                <ul className="social">
                    <li><a href="#" data-tip="Quick View"><span className="fa fa-eye"></span></a></li>
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">Straight Kurta </a></h3>
                <span className="price"><del>$775.00</del>$699.99</span>
              </div>
            </div>
          ...
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-7.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-77.jpg"/>
                </a>
                <ul className="social">
                    <li><a href="#" data-tip="Quick View"><span className="fa fa-eye"></span></a></li>
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">White T-Shirt </a></h3>
                <span className="price"><del>$675.00</del>$599.99</span>
              </div>
            </div>
          ...
          <div className="col-lg-3 col-6 product-incfhny mt-4">
            <div className="product-grid2">
              <div className="product-image2">
                <a href="#">
                  <img className="pic-1 img-fluid" src="assets/images/shop-8.jpg"/>
                  <img className="pic-2 img-fluid" src="assets/images/shop-88.jpg"/>
                </a>
                <ul className="social">
                    <li><a href="#" data-tip="Quick View"><span className="fa fa-eye"></span></a></li>
              ...
              <div className="product-content">
                <h3 className="title"><a href="#">Blue Sweater</a></h3>
                <span className="price"><del>$575.00</del>$499.99</span>
              </div>
            </div>
                    ...
                    <div className="right-side col-lg-8 pl-lg-5">
                        ...
                        <div className="sub-columns">
                            ...
                            <div className="sub-two-right">
                                ...
                                <h6>We accept:</h6>
                                <ul>
                                    <li><a className="pay-method" href="#"><span className="fa fa-cc-visa"
                                                aria-hidden="true"></span></a>
                                    </li>
                                    <li><a className="pay-method" href="#"><span className="fa fa-cc-mastercard"
                                                aria-hidden="true"></span></a>
                                    </li>
                                    <li><a className="pay-method" href="#"><span className="fa fa-cc-paypal"
                                                aria-hidden="true"></span></a>
                                    </li>
                                    <li><a className="pay-method" href="#"><span className="fa fa-cc-amex"
                                                aria-hidden="true"></span></a>
                                    </li>
                                </ul>
                            </div>
